...
main thing to be noted here is the preg_match() function which looks at our input and if it sees <p>;|&</p> then it immediately throws an error saying Input contians illegal characters
