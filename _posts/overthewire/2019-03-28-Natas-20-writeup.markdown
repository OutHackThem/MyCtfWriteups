...
Upon viewing the code it is apparently clear that we have to login as the admin.This can be understood by viewing the _print_credentials() function which has a condition of $_SESSION["admin"] == 1.
